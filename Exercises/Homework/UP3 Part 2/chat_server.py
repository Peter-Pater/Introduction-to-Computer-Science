...
#==============================================================================
                ...
                from_msg = msg[1:]
                self.indices[from_name].add_msg_and_index(from_msg)
                for g in the_guys:
                    to_sock = self.logged_name2sock[g]
                    self.indices[g].add_msg_and_index(from_msg)
                    mysend(to_sock, from_msg)
#==============================================================================
...
#==============================================================================
                ...
                ctime = str(t[0]) + "." + str(t[1]) + "." + str(t[2]) + "," + str(t[3]) + ":" + str(t[4])
